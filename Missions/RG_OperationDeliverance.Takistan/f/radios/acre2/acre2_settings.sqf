...
f_radios_settings_acre2_shortRange = ["ar", "aar", "r", "m", "ftl", "rat"];

// Set the list of units that get a long range
f_radios_settings_acre2_longRange = ["co", "m", "ftl"];
...
f_radios_settings_acre2_extraRadios = ["co"];
...
f_radios_settings_acre2_groups_blufor = ["Command Net","Test","Charlie","Delta","Echo","Foxtrot","Golf","Hotel","India","Juliet","Kilo","Lima","Mike","November","Oscar","Papa","Quebec","Romeo","Sierra","Tango","Uniform","Victor","Whiskey","X-ray","Yankee","Zulu"];
f_radios_settings_acre2_groups_opfor = ["Command Net","Test","Charlie","Delta","Echo","Foxtrot","Golf","Hotel","India","Juliet","Kilo","Lima","Mike","November","Oscar","Papa","Quebec","Romeo","Sierra","Tango","Uniform","Victor","Whiskey","X-ray","Yankee","Zulu"];
f_radios_settings_acre2_groups_indfor = ["Command Net","Test","Charlie","Delta","Echo","Foxtrot","Golf","Hotel","India","Juliet","Kilo","Lima","Mike","November","Oscar","Papa","Quebec","Romeo","Sierra","Tango","Uniform","Victor","Whiskey","X-ray","Yankee","Zulu"];
