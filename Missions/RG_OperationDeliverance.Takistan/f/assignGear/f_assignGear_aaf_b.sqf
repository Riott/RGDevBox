...
case "m":
{
	...
	if (f_param_backpacks <= 1) then {
		...
		(unitBackpack _unit) addItemCargoGlobal [_firstaid, 24];
		(unitBackpack _unit) addItemCargoGlobal [_morphene, 10];
...
case "g":
{
	...
	if (f_param_backpacks == 0) then {
		...
		(unitBackpack _unit) addItemCargoGlobal [_morphene, 1];
		(unitBackpack _unit) addItemCargoGlobal [_epi, 1];
	};
	// LOADOUT: MEDIUM
	if (f_param_backpacks == 1) then {
		_unit addBackpack _bagsmall;
		...
		(unitBackpack _unit) addMagazineCargoGlobal [_mgrenade, 0];
...
case "ar":
{
	...
	if (f_param_backpacks == 1) then {
		...
		(unitBackpack _unit) addMagazineCargoGlobal [_ARmag_Tr, 0];
		(unitBackpack _unit) addMagazineCargoGlobal [_grenade, 0];
		(unitBackpack _unit) addMagazineCargoGlobal [_mgrenade, 0];
		(unitBackpack _unit) addMagazineCargoGlobal [_smokegrenade, 0];
		(unitBackpack _unit) addItemCargoGlobal [_firstaid, 4];
...
case "rat":
{
	...
	if (f_param_backpacks == 1) then {
		...
		(unitBackpack _unit) addMagazineCargoGlobal [_mgrenade, 0];
		(unitBackpack _unit) addMagazineCargoGlobal [_smokegrenade, 0];
		(unitBackpack _unit) addMagazineCargoGlobal [_RATmag, 0];
		(unitBackpack _unit) addItemCargoGlobal [_firstaid, 4];
		(unitBackpack _unit) addItemCargoGlobal [_morphene, 1];
		(unitBackpack _unit) addItemCargoGlobal [_epi, 1];
...
case "r":
{
	...
	if (f_param_backpacks == 0) then {
		...
		_unit additem [_firstaid, 4];
		_unit additem [_morphene, 1];
		_unit additem [_epi, 1];
