...
for "_i" from 1 to 17 do {player addItemToBackpack "AGM_Bandage";};
for "_i" from 1 to 5 do {player addItemToBackpack "AGM_Morphine";};
for "_i" from 1 to 3 do {player addItemToBackpack "AGM_Epipen";};
for "_i" from 1 to 3 do {player addItemToBackpack "AGM_Bloodbag";};
